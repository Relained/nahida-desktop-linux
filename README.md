> **Linux 포트** — 원본 [myparsleycat/nahida-desktop](https://github.com/myparsleycat/nahida-desktop)에서 **모드 매니저 기능만** 분리해 Linux용으로 포팅한 포크입니다. Nahida Drive / 파일 전송 / F10 전송 / XXMI 연동 등 Windows 전용 기능은 포함되지 않습니다.
